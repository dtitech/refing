...
#if defined (EFIX64)
#define INST_DIRECTORIES L"\\EFI,\\EFI\\refing,\\EFI\\refing\\icons,\\EFI\\refing\\drivers_x64"
#define INST_DRIVERS_SUBDIR L"drivers_x64"
#define INST_REFING_NAME L"refing_x64.efi"
#define INST_PLATFORM_EXTENSION L"_x64.efi"
#elif defined(EFI32)
#define INST_DIRECTORIES L"\\EFI,\\EFI\\refing,\\EFI\\refing\\icons,\\EFI\\refing\\drivers_ia32"
#define INST_DRIVERS_SUBDIR L"drivers_ia32"
#define INST_REFING_NAME L"refing_ia32.efi"
#define INST_PLATFORM_EXTENSION L"_ia32.efi"
#elif defined(EFIAARCH64)
#define INST_DIRECTORIES L"\\EFI,\\EFI\\refing,\\EFI\\refing\\icons,\\EFI\\refing\\drivers_aa64"
#define INST_DRIVERS_SUBDIR L"drivers_aa64"
#define INST_REFING_NAME L"refing_aa64.efi"
#define INST_PLATFORM_EXTENSION L"_aa64.efi"
#else
#define INST_DIRECTORIES L"\\EFI,\\EFI\\refing,\\EFI\\refing\\icons,\\EFI\\refing\\drivers"
#define INST_DRIVERS_SUBDIR L"drivers"
#define INST_REFING_NAME L"refing.efi"
